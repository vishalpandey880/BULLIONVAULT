...
import { Database, Plus, Search, Filter, TrendingUp, DollarSign, Archive, Globe, Scale } from 'lucide-react';

export default function GoldRegistry({ goldBars, onAddGoldBar, marketPrice, onUpdateMarketPrice }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.25rem' }}>
        <div>
          <h2 style={{ fontSize: '1.85rem', marginBottom: '0.4rem', fontFamily: 'var(--font-display)', fontWeight: 700 }}>
            Gold Bar Registry & Valuations
          </h2>
          <p style={{ color: 'hsl(var(--text-secondary))', fontSize: '0.92rem' }}>
            Manage metal integrity records and inspect storage pallet values.
          </p>
        </div>
      ...
      {/* Main Grid: Add & Rank Left/Right, List bottom */}
      <div className="grid-2">
        ...
        <div className="glass-panel" style={{ padding: '1.75rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span className="badge badge-gold" style={{ fontSize: '0.62rem' }}>Asset Breakdown</span>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem', maxHeight: '335px', overflowY: 'auto', paddingRight: '0.35rem' }}>
      ...
      <div className="glass-panel" style={{ padding: '1.75rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', color: 'hsl(var(--gold-primary))' }}>
            ...
            <h3 style={{ fontSize: '1.2rem', fontWeight: 700 }}>Gold Bar Registry List</h3>
          </div>
